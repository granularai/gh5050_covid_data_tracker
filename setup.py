...
setup(
    name='GH5050_COVID_Data_Tracker',
    description="A tool to automate data fetching for COVID-19 by country",
    ...
    entry_points="""
    [console_scripts]
    covidtracker=covid_data_tracker.cli:cli
    """,
    python_requires=">=0.0.1",
    license='MIT',  # noqa
    author='Sid Gupta',
    author_email='team@granular.ai',
    # Use the URL to the github repo.
    url= 'https://github.com/granularai/covid_data_tracker',
    download_url=(
        f'https://github.com/granularai/'
        f'covid_data_tracker/archive/{version}.tar.gz'
    ),
    keywords=[
