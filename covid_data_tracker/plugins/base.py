...
class BasePlugin:
    ...
    def create_country_row(self):
        ...
        # self._absolute_case_calculations()
        # self._percent_case_calculations()
        #
        # self._absolute_death_calculations()
    ...
    def percent_gender_calculations(self, percent_column, absolute_column):
        ...
        if self.country_row[female_absolute_column] and self.country_row[male_absolute_column]:
            self.country_row[female_percent_column] = self.country_row[female_absolute_column] / self.country_row[total_absolute_column]
            self.country_row[male_percent_column] = self.country_row[male_absolute_column] / self.country_row[total_absolute_column]
    ...
    def _absolute_case_calculations(self):
        # Total no. of cases:
        # if disaggregated by sex, this should be sum of male + female cases.
        # If not disaggregated by sex, total number of cases

        # if absolute breakdown available by gender...
        # then set rows to these values
        # and set total to the sum of these values

        # else if only the total is available
        # set total to this value, and set breakdown values as N/A
        # else set everything as N/A
    ...
    def _percent_case_calculations(self):
